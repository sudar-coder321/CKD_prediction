...
This is an app for detecting whether the person has chronic kidney disease or not using Classification Algorithms based on input data taken from web UI and passing to Django sq3lite database in backend
